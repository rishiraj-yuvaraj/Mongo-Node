//to run every code => in terminal => node filename.js
...
//Task - 1
//create below files with quote2 as the content
// in backup folder
//text-1.html
//text-2.html
//text-3.html
...
//using template literals we can get multiple files
// for( let i=1; i<=10; i++){
...
//if i give a wrong file name then this will throw error
// fs.readFile("./cool.txt", "utf-8", (err,data) =>{
//     if(err){
//         console.log("❌", err);
//     }else{
